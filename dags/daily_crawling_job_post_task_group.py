...
with DAG(
    "python_crawling_job_post_task_group",
    ...
    ########### CV ###########
    ##########################
    with TaskGroup(group_id='group_cv') as group1:
    ...
    with TaskGroup(group_id='group_vnw') as group2:
    ...
    with TaskGroup(group_id='group_vl24h') as group3:
